    ...
    def make_move(self, playerId):
        ...
        for tile in tiles:
            ...
            if self.GameHelper.compare_total_units(playerId, playerId ^ 1) & self.GameHelper.compare_building_count(playerId, playerId ^ 1):
                (nearest_enemy_building_position, distance) = self.GameHelper.get_nearest_building_and_distance_belonging_to_player(tile.position[0], tile.position[1], playerId)
