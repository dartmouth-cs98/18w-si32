class BasicAI:
    ...
    def make_move(self, playerId):
        ...
        for tile in tiles:
            ...
            if self.GameHelper.compare_total_units(playerId, playerId ^ 1) & self.GameHelper.compare_building_count(playerId, playerId ^ 1) & self.GameHelper.compare_resource(playerId, playerId ^ 1):
